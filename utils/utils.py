...
def create_logger(cfg, cfg_name, phase='train'):
    root_output_dir = Path('new_output')
    # set up logger
    ...
    # Each run gets its own subdirectory with timestamp to avoid overwriting
    run_dirname = '{}_{}'.format(cfg_name, time_str)
    final_output_dir = root_output_dir / dataset / run_dirname
